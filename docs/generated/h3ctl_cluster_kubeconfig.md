## h3ctl cluster kubeconfig

Fetch kubeconfig from a bootstrapped cluster

```
h3ctl cluster kubeconfig [flags]
```
...
```
  -h, --help         help for kubeconfig
      --out string   write kubeconfig to this path instead of ~/.kube/config
```
